...
/**
 * Methods supporting a list of Slt_comments records.
 *
 * @since  1.0.0
 */
class CommentsModel extends ListModel
{
	...
	protected function getListQuery()
	{
			...
			$query->from('`#__slt_comments` AS a');
			
			
		if (!Factory::getApplication()->getIdentity()->authorise('core.edit', 'com_slt_comments'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_SLT_COMMENTS_SEARCH_FILTER_DATE_FORMAT"), "warning");
