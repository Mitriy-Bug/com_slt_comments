...
class CommentModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_SLT_COMMENTS';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_slt_comments.comment';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_slt_comments.edit.comment.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_slt_comments'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			if (@$table->ordering === '')
			{
				...
				$db->setQuery('SELECT MAX(ordering) FROM #__slt_comments');
				$max             = $db->loadResult();
