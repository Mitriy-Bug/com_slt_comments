...
namespace Slt\Component\Slt_comments\Administrator\View\Comment;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_SLT_COMMENTS_TITLE_COMMENT'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_slt_comments.comment', $this->item->id);
		}
